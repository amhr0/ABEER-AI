# AI Agent System - Direct Server Deployment
# This is a complete one-file deployment script for your server
# Upload this file to your server and run: bash deploy-ai-agent-server.sh
...
print_header() {
    echo -e "${BLUE}"
    echo "╔══════════════════════════════════════════════════════════════╗"
    echo "║           🤖 AI Agent Server Deployment                      ║"
...
deploy_ai_agent() {
    ...
    if [[ "$OPENAI_API_KEY" == "YOUR_OPENAI_API_KEY_HERE" ]]; then
        print_error "Please replace 'YOUR_OPENAI_API_KEY_HERE' with your actual OpenAI API key"
        echo ""
...
echo -e "  View logs: ${YELLOW}cd ~/ai-agent && docker-compose logs -f${NC}"
echo -e "  Setup SSL: ${YELLOW}cd ~/ai-agent && ./setup-ssl.sh${NC}"
echo -e "  Restart:   ${YELLOW}cd ~/ai-agent && docker-compose restart${NC}"
echo ""